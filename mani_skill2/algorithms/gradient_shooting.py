...
class GradientShootingAgent(GymAgent):
    ...
    def step(self, obs: torch.Tensor) -> Tuple[torch.Tensor, Dict]:
        ...
        # This function will modify self.act_sequences. I can't clone
        # self.act_sequences to act_sequences (as the commented out line below), and
        # use act_sequences in self.optimizer([act_sequences]) since
        # act_sequences would be a non-leaf Tensor and the optimizer cannot optimize a
        # non-leaf tensor. 
