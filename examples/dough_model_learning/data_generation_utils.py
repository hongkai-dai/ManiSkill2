...
class DoughRollingCenterOutAgent(GymAgent):
    ...
    def __init__(
        ...
        height_delta_between_timesteps: float = 0.0025,
    ):
        """
        Args:
            duration: Distance in meters to roll.
            start_height: Height to start rolling pin at the beginning of the episode.
            height_delta_between_timesteps: Change in height between timesteps.
                Note this is not the change in height _during_ a timestep.
        """
        self.duration = duration
        self.start_height = start_height
        self.height_delta_between_timesteps = height_delta_between_timesteps
    ...
    def step(self, obs):
        height = self.height
        self.height -= self.height_delta_between_timesteps
