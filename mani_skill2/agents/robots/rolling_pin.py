...
class RollingPin:
    ...
    scene: sapien.Scene
    robot: sapien.Actor
    cameras: typing.Dict[str, sapien.CameraEntity]
    ...
    def _setup_actor(self):
        ...
        actor_builder.add_capsule_collision(
            ...
            half_length=self.capsule_half_length,
            material=material,
            density=1E3,
            patch_radius=0.1,
    ...
    def _setup_action_space(self):
        self.action_space = spaces.Box(low=np.array([-100.] * 6),
                                       high=np.array([100.] * 6))

    def reset(self, init_qpos: typing.Union[typing.List[float], np.ndarray] = None):
        """
    ...
    def get_camera_poses(self) -> typing.Dict[str, np.ndarray]:
        poses = OrderedDict()
        return poses
