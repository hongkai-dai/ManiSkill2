...
class RollingEnv(MPMBaseEnv):
    ...
    def step_with_lift(self, action: np.ndarray) -> None:
        ...
        start_sweeing_pose is [pos_x, pos_y, pos_z, quat_x, quat_y, quat_z, quat_w]
        """
        ...
        descend_height = 0.05
        R_Wpin_start_sweeping = transforms3d.quaternions.quat2mat(
            np.array([
                start_sweeping_pose[3], start_sweeping_pose[0],
                start_sweeping_pose[1], start_sweeping_pose[2]
            ]))
